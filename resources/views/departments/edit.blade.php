...
@section('content')
    <div>
        <h3>Update Department | <a href="/departments" class="btn btn-primary">Return</a></h3>
            ...
            <div class="form-row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" id="name"
                        name="name" value="{{ old('name') ? old('name') : $department->name }}" placeholder="Name">
                    @if ($errors->has('name'))
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control {{ $errors->has('code') ? 'is-invalid' : '' }}" id="code"
                        name="code" value="{{ old('code') ? old('code') : $department->code }}" placeholder="Code">
                    @if ($errors->has('code'))
                        <div class="invalid-feedback">
                            {{ $errors->first('code') }}
                        </div>
