        ...
        <form method="POST" action="/accountabilities">
            ...
            <div class="form-row">
                <div class="col-md-6 mb-6">
                    ...
                    <div class="input-group mb-3">
                        <select class="custom-select {{ $errors->has('employee_id') ? 'is-invalid' : '' }}" id="employee"
                            name="employee_id">
            ...
            <div class="form-row">
                <div class="col-md-6 mb-6">
                    ...
                    <div class="input-group mb-3">
                        <select class="custom-select {{ $errors->has('item_id') ? 'is-invalid' : '' }}" id="item"
                            name="item_id">
                            <option value="">-- select --</option>
                            @foreach ($items as $item)
                                <option value="{{ $item->id }}"
                                    {{ (int)old('item_id') === $item->id ? 'selected' : '' }}>{{ $item->getItemFull() }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-6 mb-6">
                    ...
                    <div class="input-group mb-3">
                        <select class="custom-select {{ $errors->has('status') ? 'is-invalid' : '' }}" id="status"
                            name="status">
                            <option value="">-- select --</option>
